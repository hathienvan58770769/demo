...
public class MainTestDay04 implements ApplicationRunning {
    public static void main(String[] args) {
        MainTestDay04 mainDay04 = new MainTestDay04();
        mainDay04.run();
    }
    ...
    public static void showCustomerListInDay04(List<Customer> array) {
        for (int i = 0; i < array.size(); i++) {
            System.out.println("Villa "+i+" is name: "+array.get(i).getName() );
        }
    }
